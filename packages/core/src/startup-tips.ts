...
const TIPS = [
  ...
  "Tip: Fallback providers kick in when primary fails — configure in ~/.skeleton/config.json.",
  ...
  "Tip: Post-write lint runs after write_file/patch — JSON, TOML, Python syntax checks.",
  ...
  "Tip: Skills can declare required config settings (prompted during setup).",
  ...
  "Tip: Config validation at startup catches JSON typos before cryptic runtime errors.",
  ...
  "Tip: Credential sources: resolve from config.json or env — keep secrets out of code.",
];
